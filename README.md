<p align="center"><img src="p/a.png" width="350px"></p>
<h1 align="center">pfetch</h1>
<p align="center">A pretty system information tool written in POSIX sh</p><br>

<img src="p/b.png" width="40%" align="right">
...
- **Linux**
    - Alpine Linux, Arch Linux, Arco Linux, Artix Linux, BargOS, CentOS, Dahlia, Debian, Devuan, Elementary, EndeavourOS, Fedora, Garuda Linux, Gentoo, Guix, Hyperbola, instantOS, KISS Linux, Linux Lite, Linux Mint, Mageia, Manjaro, MX Linux, NixOS, OpenSUSE, Parabola, Pop!\_OS, PureOS, Slackware, Solus, Ubuntu and Void Linux.
...
PF_INFO="title os host kernel uptime pkgs memory shell editor wm de palette"
